...
| `vis cluster` | Cluster embeddings and show top tokens + date ranges per cluster | `uv run bookmarks vis cluster --artifact vectors.pt --clusters 6` |
...
# 3. explore clusters (shows date ranges and top tokens)
uv run bookmarks vis cluster --artifact vectors.pt --clusters 6
