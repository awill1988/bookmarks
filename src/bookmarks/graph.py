...
DEFAULT_DB_PATH = Path("bookmark_vectors.db")
...
def embed_bookmarks_node(model: FastEmbedEmbeddings):
...
def build_demo_graph(model_name: str = "BAAI/bge-small-en-v1.5"):
    """Create a simple LangGraph pipeline to embed bookmarks into sqlite."""
